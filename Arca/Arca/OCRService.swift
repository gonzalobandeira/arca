...
class OCRService: ObservableObject {
    ...
    func processImage(_ image: UIImage, completion: @escaping (CoordinateCard?) -> Void) {
        ...
        let request = VNRecognizeTextRequest { request, error in
            ...
            let parsedCard = self.parseObservations(observations, inImageSize: image.size)
            completion(parsedCard)
        }
